...
object ThereIsAProblemUploadingYourGiftAidSchedulePage_Quarantine extends BasePage {

  override def pageUrl: String = s"$hostname/problem-uploading-gift-aid-schedule-quarantine"
