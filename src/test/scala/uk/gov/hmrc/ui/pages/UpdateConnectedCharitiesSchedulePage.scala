...
object UpdateConnectedCharitiesSchedulePage extends BasePage {
  ...
  override def pageTitle: String =
    "Are you sure you want to update this Connected Charities schedule? - Make a charity tax repayment claim - GOV.UK"
  ...
  def errorMsg: String =
    "Select ‘Yes’ if you want to update this Connected Charities schedule"
