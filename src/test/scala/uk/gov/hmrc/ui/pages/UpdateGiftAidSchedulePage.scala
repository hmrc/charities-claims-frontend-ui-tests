...
object UpdateGiftAidSchedulePage extends BasePage {
  ...
  override def pageTitle: String =
    "Are you sure you want to update this Gift Aid schedule? - Make a charity tax repayment claim - GOV.UK"
  ...
  def validateNavigation(): Unit = {
    ...
    UpdateGiftAidSchedulePage.verifyPageHeading(UpdateGiftAidSchedulePage.pageHeading)
