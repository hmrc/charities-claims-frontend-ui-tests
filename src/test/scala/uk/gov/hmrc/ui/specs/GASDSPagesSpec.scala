...
//    }
    ...
    Scenario(
      ...
      RepaymentCheckboxPage.verifyPageUrl(s"$hostname/change-which-tax-year-are-you-claiming-for/1")
      RepaymentCheckboxPage.verifyPageHeading("Which tax year are you claiming for?")
      WhichTaxYearAreYouClaimingForPage.clickContinue()
