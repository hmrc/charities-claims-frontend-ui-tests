...
class OldGiftAidPagesSpec
  ...
  Feature("Charities - Organisation - Gift Aid Page Validations") {
    ...
    Scenario(
      ...
      OldDoYouWantToClaimATopUpUnderGASDSPage.validateHint()
      Then(
      ...
      OldDoYouWantToClaimATopUpUnderGASDSPage.validateErrorMessage()
    }
    ...
    Scenario(
      ...
      OldDoYouWantToClaimForDonationsCollectedInCommunityBuildingsPage.validateHint()
      Then(
        "User validates the 'no input' error on the 'Do you want to claim for donations collected in community buildings?' page"
      )
      OldDoYouWantToClaimForDonationsCollectedInCommunityBuildingsPage.validateErrorMessage()
    }
    ...
    Scenario(
      ...
      OldConnectedCharitiesPage.navigateToPage(OldConnectedCharitiesPage.pageUrl)
      OldConnectedCharitiesPage.validateNavigation()
      OldConnectedCharitiesPage.validateParagraph()
      Then("User validates the 'no input' error on the 'Connected charities and Community Amateur Sports Clubs' page")
      OldConnectedCharitiesPage.validateErrorMessage()
    }
