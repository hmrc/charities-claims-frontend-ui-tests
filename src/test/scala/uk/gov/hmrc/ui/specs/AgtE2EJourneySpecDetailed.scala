...
import uk.gov.hmrc.ui.pages.{CheckYourRepaymentClaimPage, *}
...
//    }
    ...
    // TODO normal ref then CH/CF ref
...
//    }
    ...
    Scenario(
      ...
      Then(
        "User validates the 'no input' error on the 'Does the authorised official have a UK address?' page"
      )
      ...
      CheckYourOrganisationDetailsPage.assertAllSummaryPairsExactlyAt(1)(
        "UK address"                                       -> "No",
        "Official’s details"                               -> "TEST TESTFORENAME TESTSURNAME 01632 960999"
      )
      And("User navigates to 'Make a charity repayment claim' task list page")
      CheckYourOrganisationDetailsPage.clickContinue()
    }
...
//      Then("User validates the expected missing info on the 'This claim cannot be setup' page")
//      ThisClaimCannotBeSetupPage_GASDS.validatePageContent()
//    }
//
//    Scenario(
